...
const CreateExercise = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log(title, complexity, textExercise)

        createExercise(title, textExercise, complexity)
...
return (
    <div className='w-full h-screen'>
                ...
                <div className="flex h-1/5 w-3/4 mt-0 m-auto ">
                    ...
                    <div className="flex-1 p-4 ">
                        <div>
                            ...
                            <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" name="email" id="email" className=" px-3 mb-4 shadow-lg shadow-gray-400 border border-custom-blue text-custom-black sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Add Title" />
                        </div>
                    </div>
                    ...
                    <div className="flex-1 p-4">
                        <div>
                            ...
                            p-2.5 bg-white" aria-label="Default select example"
                                value={complexity} onChange={(e) => setComplexity(e.target.value)}>
                                <option defaultValue={selectedValue} className='form-select bg-white text-custom-blue'> Select Complexity</option>
        ...
        focus-visible:outline-0 overflow-y-auto"
                ...
                <button className='w-1/5 justify-center  py-2 mb-10 bg-custom-blue hover:bg-blue-400 rounded-lg'>Submit</button>
